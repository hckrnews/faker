...
const Word = function (faker) {
  ...
  self.adjective = function (length) {
    let wordList = faker.definitions.word.adjective
    if (length !== undefined) {
  ...
  self.adverb = function (length) {
    let wordList = faker.definitions.word.adverb
    if (length !== undefined) {
      length = parseInt(length)
  ...
  self.conjunction = function (length) {
    let wordList = faker.definitions.word.conjunction
    if (length !== undefined) {
      length = parseInt(length)
  ...
  self.interjection = function (length) {
    let wordList = faker.definitions.word.interjection
    if (length !== undefined) {
      length = parseInt(length)
  ...
  self.noun = function (length) {
    let wordList = faker.definitions.word.noun
    if (length !== undefined) {
      length = parseInt(length)
  ...
  self.preposition = function (length) {
    let wordList = faker.definitions.word.preposition
    if (length !== undefined) {
      length = parseInt(length)
  ...
  self.verb = function (length) {
    let wordList = faker.definitions.word.verb
    if (length !== undefined) {
      length = parseInt(length)
