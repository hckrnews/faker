...
function Name (faker) {
  ...
  this.findName = function (firstName, lastName, gender) {
    const r = faker.datatype.number(8)
    let prefix, suffix
   ...
   */
  this.title = function () {
    const descriptor = faker.random.arrayElement(faker.definitions.name.title.descriptor)
    const level = faker.random.arrayElement(faker.definitions.name.title.level)
    const job = faker.random.arrayElement(faker.definitions.name.title.job)
