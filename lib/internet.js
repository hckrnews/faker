...
const Internet = function (faker) {
  ...
  self.exampleEmail = function (firstName, lastName) {
    const provider = faker.random.arrayElement(faker.definitions.internet.example_email)
  ...
  self.color = function (baseRed255, baseGreen255, baseBlue255) {
    ...
    const red = Math.floor((faker.datatype.number(256) + baseRed255) / 2)
    const green = Math.floor((faker.datatype.number(256) + baseGreen255) / 2)
    const blue = Math.floor((faker.datatype.number(256) + baseBlue255) / 2)
